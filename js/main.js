(function ($) {
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({siteLogo: "<a href='index.html' class='logo-mobile-menu'><img src='img/cucssa_mobile_logo.png' /></a>"});
    ...
    if(eventCounter.length){
        eventCounter.countdown('2017/03/25', function (e) {
